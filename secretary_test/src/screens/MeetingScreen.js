...
const s = StyleSheet.create({
  ...
  editTitleBtnText: { color: C.accentBlue, fontSize: 11, fontWeight: '500' },
  contentEditBtn: {
    borderWidth: 1, borderColor: C.accentTeal + '55', borderRadius: 7,
    paddingVertical: 5, paddingHorizontal: 6,
  },
  contentEditBtnText: { color: C.accentTeal, fontSize: 11, fontWeight: '500' },
  contentEditInput: {
    backgroundColor: C.bg, borderWidth: 1, borderColor: C.borderHigh,
    borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12,
  ...
  speakerEditBtn: {
    borderWidth: 1, borderColor: C.accentPurple + '55', borderRadius: 7,
    paddingVertical: 5, paddingHorizontal: 6,
  },
  speakerEditBtnText: { color: C.accentPurple, fontSize: 11, fontWeight: '500' },
  ...
  segmentEditBtn: {
    borderWidth: 1, borderColor: C.gold + '55', borderRadius: 7,
    paddingVertical: 5, paddingHorizontal: 6,
  },
  ...
  fixForeignBtn: {
    borderWidth: 1, borderColor: '#5AAF7A55', borderRadius: 7,
    paddingVertical: 5, paddingHorizontal: 6,
  },
  fixForeignBtnText: { color: '#5AAF7A', fontSize: 11, fontWeight: '500' },
  fixForeignBtnDisabled: { opacity: 0.4 },
  deleteBtn: {
    borderWidth: 1, borderColor: C.red + '55', borderRadius: 7,
    paddingVertical: 5, paddingHorizontal: 6,
  },
